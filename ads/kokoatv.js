    ...
    products.forEach(({ linkimg, linkproduct }) => {
      ...
      slide.innerHTML = `
        ...
        <button class="copy-btn" data-link="${linkproduct}"
          style="position: absolute; top: 90px; right: 10px; padding: 6px 12px; border: none; border-radius: 8px; background: white; color: black; font-weight: bold; cursor: pointer; box-shadow: 0 2px 6px rgba(0,0,0,0.3);">
          🔗 Link
        </button>`;
